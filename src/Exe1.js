...
function comparadorBasico(elemento1, elemento2) {
    let comparador = undefined;
    
    if (elemento1 === elemento2) {
        comparador = ('Elemento ' + elemento1 + ' ('+ typeof(elemento1)+') ' + 'é estritamente igual ao elemento ' + elemento2 + ' ('+ typeof(elemento2)+')')
        return comparador
    }
    if (elemento1 == elemento2) {
        comparador = ('Elemento ' + elemento1 + ' ('+ typeof(elemento1)+') ' + 'é equivalente ao elemento ' + elemento2 + ' ('+ typeof(elemento2)+')')
        return comparador
    }
    if (elemento1 != elemento2) {
        comparador = ('Elemento ' + elemento1 + ' ('+ typeof(elemento1)+') ' + 'é diferente do elemento ' + elemento2 + ' ('+ typeof(elemento2)+')')
        return comparador
    }
}
